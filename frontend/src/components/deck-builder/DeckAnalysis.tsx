...
export default function DeckAnalysis({ notes, onHighlightCards }: Props) {
  ...
  return (
    <div className="min-w-[340px] flex-1 border-l border-gray-800 flex flex-col bg-gray-950/80 overflow-hidden">
      {/* Header */}
      <div className="px-4 pt-3 pb-2 border-b border-gray-800/50">
        <div className="flex items-center gap-2">
          <div className="w-6 h-6 rounded-lg bg-blue-600/20 flex items-center justify-center text-xs">
            {'\u{1F916}'}
          </div>
          <h3 className="text-white font-semibold text-sm">AI Strategy Guide</h3>
        </div>
        {summary && (
          <p className="text-gray-400 text-[11px] mt-2 leading-relaxed">{summary}</p>
        )}
      </div>
