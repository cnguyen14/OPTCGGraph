...
function GamePanel({
  ...
  return (
    <div className="rounded-lg border border-gray-700/40 bg-gray-900/40 overflow-hidden">
      ...
      {/* Expanded content */}
      {expanded && (
        <div className="border-t border-gray-700/30 max-h-[600px] overflow-y-auto">
          {/* Column headers */}
          <div className="grid grid-cols-2 gap-0 sticky top-0 bg-gray-900/95 border-b border-gray-700/30 z-10">
            <div className="px-4 py-2 text-xs font-semibold text-blue-400 border-r border-gray-700/30">
          ...
          {/* Turn rows */}
          {turns.map((td) => (
            <div key={td.turn} className="border-b border-gray-800/40 py-3 px-4">
              {/* Turn header */}
              ...
              <div className="grid grid-cols-2 gap-3 border-t border-gray-800/20 pt-1.5">
