...
export default function AIChat({ sessionId, onSessionId }: Props) {
  ...
  return (
    <div className="relative flex flex-col h-full rounded-[var(--radius-glass-lg)] border border-glass-border-hover overflow-hidden"
      ...
      <div className="relative z-10 p-4 border-b border-glass-border">
        ...
        <p className="text-xs text-text-muted mt-0.5">Ask about cards, deck builds, synergies, counters...</p>
      </div>
      ...
      {/* Input */}
      <div className="relative z-10 p-3 border-t border-glass-border">
