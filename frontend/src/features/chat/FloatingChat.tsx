...
export default function FloatingChat({ sessionId, onSessionId, leaderId, deckCardIds, onUiUpdate, onOpenChange }: Props) {
      ...
      {open && (
        <>
          ...
          <div className="relative z-10 px-4 py-3 border-b border-glass-border flex items-center justify-between shrink-0">
            ...
            <button onClick={() => handleToggle(false)} className="text-text-secondary hover:text-text-primary transition-colors cursor-pointer">
              ...
              <div key={msg.id} className={`flex ${msg.role === 'user' ? 'justify-end' : 'justify-start'}`}>
                {msg.role === 'assistant' ? (
                  <div className="max-w-[90%] space-y-1.5">
                    ...
                    <div className="glass-subtle rounded-lg px-3 py-2.5 text-xs text-text-secondary prose prose-invert prose-xs max-w-none
                      prose-headings:text-text-primary prose-headings:font-semibold prose-headings:mt-3 prose-headings:mb-1
                      prose-h2:text-sm prose-h3:text-xs prose-p:my-1.5 prose-li:my-0.5 prose-strong:text-text-primary">
              ...
              <div className="flex justify-start">
                <div className="max-w-[90%] space-y-2">
                  ...
                  {streamingText ? (
                    ...
                    <div className="glass-subtle rounded-lg px-3 py-2.5 text-xs text-text-muted flex items-center gap-2">
