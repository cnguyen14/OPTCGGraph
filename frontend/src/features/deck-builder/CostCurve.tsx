...
export default function CostCurve({ curve }: Props) {
  ...
  return (
    <div className="bg-surface-2/50 rounded-lg p-2 border border-glass-border/30">
      <p className="text-[10px] text-text-muted uppercase tracking-wider mb-1 px-1">Cost Curve</p>
