...
This project is indexed by GitNexus as **OPTCGGraph** (2613 symbols, 7533 relationships, 220 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
